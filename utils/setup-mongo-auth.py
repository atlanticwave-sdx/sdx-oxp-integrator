...
ROOT_USER = os.getenv("MONGO_INITDB_ROOT_USERNAME", "root_user")
ROOT_PASS = os.getenv("MONGO_INITDB_ROOT_PASSWORD", "root_pw")
...
if ROOT_USER != USER:
    ...
    for i in range(60):
        try:
            ...
            print("Error creating mongo DBNAME: %s" % DBNAME)
        time.sleep(2)
    else:
