...
class Link(Model):
    ...
    def link_id(self, link_id):
        ...
        if link_id is not None and not re.search(
            r"^((urn:sdx:link:)[A-Za-z_.-]*$)", link_id
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `link_id`, must be a follow pattern or equal to `/^((urn:sdx:link:)[A-Za-z_.-]*$)/`"
            )  # noqa: E501
    ...
    def bandwidth(self, bandwidth):
        ...
        if bandwidth is not None and bandwidth > 1000000:  # noqa: E501
            raise ValueError(
                "Invalid value for `bandwidth`, must be a value less than or equal to `1000000`"
            )  # noqa: E501
        if bandwidth is not None and bandwidth < 1:  # noqa: E501
            raise ValueError(
                "Invalid value for `bandwidth`, must be a value greater than or equal to `1`"
            )  # noqa: E501
    ...
    def residual_bandwidth(self, residual_bandwidth):
        ...
        if residual_bandwidth is not None and residual_bandwidth > 100:  # noqa: E501
            raise ValueError(
                "Invalid value for `residual_bandwidth`, must be a value less than or equal to `100`"
            )  # noqa: E501
        if residual_bandwidth is not None and residual_bandwidth < 0:  # noqa: E501
            raise ValueError(
                "Invalid value for `residual_bandwidth`, must be a value greater than or equal to `0`"
            )  # noqa: E501
    ...
    def latency(self, latency):
        ...
        if latency is not None and latency > 1000000:  # noqa: E501
            raise ValueError(
                "Invalid value for `latency`, must be a value less than or equal to `1000000`"
            )  # noqa: E501
        if latency is not None and latency < 1:  # noqa: E501
            raise ValueError(
                "Invalid value for `latency`, must be a value greater than or equal to `1`"
            )  # noqa: E501
    ...
    def packet_loss(self, packet_loss):
        ...
        if packet_loss is not None and packet_loss > 100:  # noqa: E501
            raise ValueError(
                "Invalid value for `packet_loss`, must be a value less than or equal to `100`"
            )  # noqa: E501
        if packet_loss is not None and packet_loss < 0:  # noqa: E501
            raise ValueError(
                "Invalid value for `packet_loss`, must be a value greater than or equal to `0`"
            )  # noqa: E501
    ...
    def availability(self, availability):
        ...
        if availability is not None and availability > 100:  # noqa: E501
            raise ValueError(
                "Invalid value for `availability`, must be a value less than or equal to `100`"
            )  # noqa: E501
        if availability is not None and availability < 0:  # noqa: E501
            raise ValueError(
                "Invalid value for `availability`, must be a value greater than or equal to `0`"
            )  # noqa: E501
